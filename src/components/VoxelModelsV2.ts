...
export function buildVoxelSpartanModelV2(
  ...
  const helmetVoxels = getVoxelSegmentDataV2('helmet', loadout.helmet ?? 'mark-vi', customHue, isEnemy);
  const torsoVoxels = getVoxelSegmentDataV2('torso', loadout.torso ?? 'mark-vi', customHue, isEnemy);
  const leftArmVoxels = getVoxelSegmentDataV2('leftArm', loadout.arm ?? 'mark-vi', customHue, isEnemy);
  const rightArmVoxels = getVoxelSegmentDataV2('rightArm', loadout.arm ?? 'mark-vi', customHue, isEnemy);
  const leftLegVoxels = getVoxelSegmentDataV2('leftLeg', loadout.leg ?? 'mark-vi', customHue, isEnemy);
  const rightLegVoxels = getVoxelSegmentDataV2('rightLeg', loadout.leg ?? 'mark-vi', customHue, isEnemy);
