...
export const V3_DEFAULT_CHARACTER_BUDGET_LIMITS: V3BudgetSummary = {
  ...
  sourceVoxelCount: 26000,
  mergedBoxCount: 3200,
  materialGroupCount: 104,
  drawCallEstimate: 104,
  memoryEstimateKb: 5000,
};
...
export const BUILT_IN_V3_CHARACTER_PARTS: readonly V3CharacterPartManifest[] = [
  ...
  createCharacterPart({
    ...
    budget: createBudget(850, 140, 5, 5, 3, 160),
  }),
  createCharacterPart({
    slot: 'upperArmRight',
  ...
  createCharacterPart({
    ...
    budget: createBudget(880, 150, 5, 5, 3, 165),
  }),
  createCharacterPart({
    slot: 'forearmRight',
  ...
  createCharacterPart({
    ...
    budget: createBudget(320, 110, 4, 4, 2, 60),
  }),
  createCharacterPart({
    slot: 'handRight',
  ...
  createCharacterPart({
    ...
    budget: createBudget(1600, 165, 6, 6, 3, 300),
  }),
  createCharacterPart({
    slot: 'thighLeft',
    label: 'Aegis Left Thigh Plate',
    roles: ['primary', 'secondary', 'undersuit'],
    budget: createBudget(1200, 160, 5, 5, 3, 225),
  }),
  createCharacterPart({
    slot: 'thighRight',
  ...
  createCharacterPart({
    ...
    roles: ['primary', 'accent', 'undersuit'],
    budget: createBudget(1200, 140, 5, 5, 3, 225),
  }),
  createCharacterPart({
    slot: 'shinRight',
  ...
  createCharacterPart({
    ...
    roles: ['primary', 'secondary', 'accent'],
    budget: createBudget(1000, 110, 4, 4, 3, 190),
  }),
  createCharacterPart({
    slot: 'footRight',
  ...
  createCharacterPart({
    ...
    budget: createBudget(1400, 180, 5, 5, 3, 260),
  }),
];
