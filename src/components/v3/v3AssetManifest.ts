...
export const V3_DEFAULT_CHARACTER_BUDGET_LIMITS: V3BudgetSummary = {
  ...
  sourceVoxelCount: 48000,
  mergedBoxCount: 50000,
  materialGroupCount: 95,
  drawCallEstimate: 95,
  memoryEstimateKb: 10000,
};
...
export const BUILT_IN_V3_CHARACTER_PARTS: readonly V3CharacterPartManifest[] = [
  ...
  createCharacterPart({
    ...
    budget: createBudget(1150, 800, 6, 6, 3, 230),
  }),
  createCharacterPart({
    slot: 'chest',
    label: 'Aegis Core Chestplate',
    roles: ['undersuit', 'secondary', 'accent', 'decal', 'fixed'],
    budget: createBudget(6900, 9800, 5, 5, 3, 1400),
  }),
  createCharacterPart({
    slot: 'shoulderLeft',
  ...
  createCharacterPart({
    ...
    budget: createBudget(1500, 800, 5, 5, 3, 300),
  }),
  createCharacterPart({
    slot: 'upperArmRight',
  ...
  createCharacterPart({
    ...
    budget: createBudget(1300, 1450, 3, 3, 3, 260),
  }),
  createCharacterPart({
    slot: 'forearmRight',
  ...
  createCharacterPart({
    ...
    budget: createBudget(650, 350, 3, 3, 2, 120),
  }),
  createCharacterPart({
    slot: 'handRight',
  ...
  createCharacterPart({
    ...
    budget: createBudget(5700, 5400, 3, 3, 3, 1100),
  }),
  createCharacterPart({
    slot: 'thighLeft',
    label: 'Aegis Left Thigh Plate',
    roles: ['undersuit', 'secondary', 'accent'],
    budget: createBudget(2000, 1900, 6, 6, 3, 400),
  }),
  createCharacterPart({
    slot: 'thighRight',
  ...
  createCharacterPart({
    ...
    budget: createBudget(2550, 3100, 6, 6, 3, 520),
  }),
  createCharacterPart({
    slot: 'shinRight',
