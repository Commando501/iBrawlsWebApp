...
export const BUILT_IN_V3_CHARACTER_PARTS: readonly V3CharacterPartManifest[] = [
  createCharacterPart({
    ...
    roles: ['primary', 'decal', 'emissive'],
    budget: createBudget(10200, 5800, 3, 3, 3, 2600),
  }),
  createCharacterPart({
    slot: 'neck',
    label: 'Aegis Sealed Collar',
    roles: ['primary', 'secondary', 'undersuit', 'decal'],
    budget: createBudget(3600, 2600, 4, 4, 3, 900),
  }),
  createCharacterPart({
    slot: 'chest',
    label: 'Aegis Core Chestplate',
    roles: ['primary', 'undersuit', 'emissive', 'decal'],
    budget: createBudget(22000, 12500, 4, 4, 3, 5000),
  }),
  createCharacterPart({
    slot: 'shoulderLeft',
    label: 'Aegis Left Guard',
    roles: ['primary', 'undersuit', 'decal'],
  ...
  createCharacterPart({
    ...
    roles: ['primary', 'secondary', 'undersuit', 'emissive', 'decal'],
  ...
  createCharacterPart({
    ...
    roles: ['primary', 'undersuit', 'emissive', 'decal'],
    budget: createBudget(9400, 5400, 4, 4, 3, 2300),
  }),
  createCharacterPart({
    slot: 'thighRight',
  ...
  createCharacterPart({
    ...
    roles: ['primary', 'undersuit', 'decal'],
    budget: createBudget(9200, 5200, 4, 4, 3, 2300),
  }),
  createCharacterPart({
    slot: 'shinRight',
