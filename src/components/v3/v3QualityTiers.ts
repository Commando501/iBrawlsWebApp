...
export function normalizeV3SourceFidelity(
  value: unknown,
  fallback: V3SourceFidelity = 'runtimeLod'
): V3SourceFidelity {
  return value === 'exact' || value === 'runtimeLod' ? value : fallback;
}
