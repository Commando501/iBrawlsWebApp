...
export function buildV3RuntimeSmokeChecklist(): V3RuntimeSmokeChecklistItem[] {
  return [
    ...
    },
    {
      ...
      expectedText: ['Phase 26 Ready', 'mobileLow', 'visual pass', 'motion pass', 'LOD pass', 'models 8'],
      viewports: ['mobile'],
    },
    {
      id: 'performance-smoke-desktop',
      path: '/v3-performance-smoke.html?tier=desktop',
      expectedText: ['Phase 26 Ready', 'desktop', 'visual pass', 'motion pass', 'LOD pass', 'models 8'],
      viewports: ['desktop'],
    },
  ];
}
