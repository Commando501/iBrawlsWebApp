  ...
  return [
    ...
    },
    {
      ...
      expectedText: [
        ...
        'Static Body Baseline',
        'Reference Feature Match',
        'Exact OBJ Voxel Source',
        'Segmentation Review',
        'Motion Retarget',
      ],
      viewports: ['desktop'],
    ...
    {
      id: 'animation-atlas-smoke-local-tooling',
      path: '/v3-animation-atlas-smoke.html',
      expectedText: [
        'V3 Animation Atlas Smoke',
        'Animation',
        'Play All',
        'Frame +',
        'Normalized Review',
    ...
    },
    {
      ...
      expectedText: ['Phase 41 Ready', 'mobileLow', 'visual pass', 'motion pass', 'motion-retarget pass', 'LOD pass', 'models 8'],
      viewports: ['mobile'],
    },
    {
      id: 'performance-smoke-desktop',
      path: '/v3-performance-smoke.html?tier=desktop',
      expectedText: ['Phase 41 Ready', 'desktop', 'visual pass', 'motion pass', 'motion-retarget pass', 'LOD pass', 'models 8'],
      viewports: ['desktop'],
    },
  ];
}
